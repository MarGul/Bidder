...
var update = __webpack_require__(8)("4bf41472", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-95a9e666\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./User.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-95a9e666\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./User.vue");
...
// module
exports.push([module.i, "\n.user-view {\n  display: flex;\n}\n.user-view .user-navigation {\n    flex: 1;\n}\n.user-view .user-navigation .user-nav {\n      list-style-type: none;\n}\n.user-view .user-navigation .user-nav li {\n        margin-bottom: 15px;\n}\n.user-view .user-navigation .user-nav li a {\n          color: #6D717A;\n          font-size: 15px;\n          display: flex;\n          align-items: center;\n}\n.user-view .user-navigation .user-nav li a svg {\n            margin-right: 15px;\n}\n.user-view .user-navigation .user-nav li a svg path, .user-view .user-navigation .user-nav li a svg circle, .user-view .user-navigation .user-nav li a svg polygon {\n              fill: #97A9B5;\n}\n.user-view .user-navigation .user-nav li a.active {\n            color: #009999;\n            font-weight: bold;\n}\n.user-view .user-navigation .user-nav li a.active svg path, .user-view .user-navigation .user-nav li a.active svg circle, .user-view .user-navigation .user-nav li a.active svg polygon {\n              fill: #009999 !important;\n}\n.user-view .user-navigation .user-nav li a:hover {\n            text-decoration: none;\n            font-weight: bold;\n}\n.user-view .user-navigation .user-nav li a:hover svg path, .user-view .user-navigation .user-nav li a:hover svg circle, .user-view .user-navigation .user-nav li a:hover svg polygon {\n              fill: #6D717A;\n}\n.user-view .user-navigation .user-nav li a:focus {\n            text-decoration: none;\n}\n.user-view .user-content {\n    flex: 3;\n}\n", ""]);
